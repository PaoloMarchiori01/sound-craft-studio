...
const AboutSection = () => {
  ...
  const highlights = [
    { icon: <Music className="w-5 h-5" />, text: "Batterista dal 2008" },
    { icon: <Award className="w-5 h-5" />, text: "Certificato NAM Milano" },
    { icon: <Building2 className="w-5 h-5" />, text: "L'n'R Production" },
  ];

  return (
    <section id="chi-sono" className="section-container">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            className="mt-8 mx-auto flex items-center gap-2 glass-button px-6 py-3 rounded-xl"
